...
;**************************************************************************	
ListViewARCBoldItem PROC USES RBX RCX lParam:QWORD, dqAltRowColor:QWORD, nBoldItem:QWORD, hBoldFont:QWORD, hNormalFont:QWORD
    ...
    .ELSEIF eax == CDDS_ITEMPREPAINT or CDDS_SUBITEM
    	...
    	.IF  _mod(rax,2) == 0                                 ; Calc mod of item to see if the background should be applied
