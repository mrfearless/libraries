...
;**************************************************************************	
ListViewInsertColumn PROC FRAME  hListview:QWORD, dqFormat:QWORD, dqWidth:QWORD, lpszColumnText:QWORD 
    LOCAL LVC:LV_COLUMN
    LOCAL iCol:QWORD
    
    Invoke ListViewGetColumnCount, hListview
    mov iCol, rax
	mov LVC.mask_, LVCF_FMT or LVCF_TEXT or LVCF_WIDTH  ;or LVCFMT_COL_HAS_IMAGES
	mov rax, dqFormat
...
ListViewInsertColumnImage PROC FRAME  hListview:QWORD, dqFormat:QWORD, dqWidth:QWORD, lpszColumnText:QWORD, nImageListIndex:QWORD
    LOCAL LVC:LV_COLUMN
    LOCAL iCol:QWORD
    
    Invoke ListViewGetColumnCount, hListview
    mov iCol, rax
	mov LVC.mask_, LVCF_FMT or LVCF_TEXT or LVCF_WIDTH or LVCF_IMAGE
	mov rax, dqFormat
    mov LVC.fmt, eax ; defaults to LVCFMT_LEFT
    mov rax, lpszColumnText	
	mov LVC.pszText, rax
